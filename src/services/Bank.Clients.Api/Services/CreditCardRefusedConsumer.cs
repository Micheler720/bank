...
public class CreditCardRefusedConsumer :
    MessageConsumer<CreditCardRefusedEvent>
{
    private readonly IClientRepository _clientRepository;

    public CreditCardRefusedConsumer(IClientRepository clientRepository)
    {
        _clientRepository = clientRepository;
    }

    public async override Task ConsumeMessage(ConsumedMessage<CreditCardRefusedEvent> message)
    {
